...
sudo rm -vrf $2
sudo mkdir -vp $2
sudo cqtdeployer -bin $1 -qmake /opt/rootfs/01_PS_conan_QT/qt-install/bin/qmake -targetDir $2 -verbose 3 -libDir /usr/lib/arm-linux-gnueabihf /lib/arm-linux-gnueabihf /usr/arm-linux-gnueabihf/lib -enablePlugins qxcb deploySystem
sudo chmod -R 775 $2
